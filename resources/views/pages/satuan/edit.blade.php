                    ...
                    <div class="col-md-12">
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">Ubah Satuan Zakat</h3>

                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form method="POST" action="{{ route('satuan.update', $data->id) }}" class="form-horizontal">
                                @method('PUT')
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input value="{{ $data->satuan }}" name="satuan" type="text"
                                                class="form-control" id="satuan" placeholder="Tulis satuan zakat">
                                        </div>
                                    </div>
                                </div>
                                <!-- /.card-body -->
